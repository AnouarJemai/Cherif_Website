...
interface Props {
  onBook: (activity: Activity) => void; // ✅ passed from App.tsx
}

export default function ActivitiesPage({ onBook }: Props) {
  ...
  return (
    <div style={{ background: '#060c06', minHeight: '100%', padding: '24px 18px 20px' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <p style={{
          color: '#C9A84C', fontSize: 10, letterSpacing: 4,
        ...
        <div style={{
          ...
          {filtered.map((a, i) => (
            <ActivityCard
              ...
              activity={a}
              index={i}
              onBook={onBook} // ✅ forward the callback
            />
          ))}
        </div>
